...
const graphql_query_repos =
  "query($login:String!){organization(login:$login){repositories(first:100){edges{node{name pullRequests(last:1){edges{node{number}}}}}}}}";
...
module.exports = {
  ...
  qraphQlPullRequest: (owner, repo, prNumber) =>
    call_qraphQlPullRequest(owner, repo, prNumber),
};
